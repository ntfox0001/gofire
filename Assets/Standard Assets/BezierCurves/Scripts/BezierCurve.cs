...
public class BezierCurve : MonoBehaviour {
    ...
    /// <summary>
    /// 	- Gets the local point at 't' percent along this curve
    /// </summary>
    /// <returns>
    /// 	- Returns the point at 't' percent
    /// </returns>
    ...
    public Vector3 GetLocalPointAt(float t)
    {
        ...
        t -= totalPercent;
        return GetLocalPoint(p1, p2, t / curvePercent);
    }
    ...
    /// <summary>
    /// 	- Gets the local point 't' percent along a curve
    /// 	- Automatically calculates for the number of relevant points
    /// </summary>
    /// <returns>
    /// 	- The point 't' percent along the curve
    ...
    /// 	- Value between 0 and 1 representing the percent along the curve (0 = 0%, 1 = 100%)
    /// </param>
    public static Vector3 GetLocalPoint(BezierPoint p1, BezierPoint p2, float t)
    {
        if (p1.handle2 != Vector3.zero)
        {
