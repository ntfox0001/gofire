            ...
            if (reader.Token == JsonToken.ArrayStart) {
                ...
                while (true) {
                    ...
                    if (t_data.Properties.ContainsKey (property)) {
                        ...
                        else if (args[0] == typeof(uint))
                        {
                            ((IDictionary)instance).Add(
                            uint.Parse(property), ReadValue(
                                t_data.ElementType, reader));
                        }
                        ...
                        else if (args[0] == typeof(long))
                        {
                            ((IDictionary)instance).Add(
                            long.Parse(property), ReadValue(
                                t_data.ElementType, reader));
                        }
                        else
                        {
                            throw new JsonException("Un-support key type:" + args[0].ToString());
                        }
